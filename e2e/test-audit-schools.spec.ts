...
test('Audit panel - check school grouping', async ({ page }) => {
  ...
  // Get ALL text from the audit modal
  const modalText = await page.locator('.max-w-4xl').innerText()
  console.log('=== FULL AUDIT MODAL TEXT ===')
  console.log(modalText)

  await page.screenshot({ path: 'test-results/audit-schools.png', fullPage: true })
})
