        ...
        <div className="space-y-10">
          ...
          <section className="max-w-4xl mx-auto px-6">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h2 className="text-apple-title text-[#1d1d1f]">Consultar Aluno</h2>
            </div>
              ...
              <div className="max-w-4xl mx-auto px-6">
                <div className="flex items-center gap-4 py-4">
                  ...
                  <div className="flex items-center gap-2 px-4 py-2 bg-white rounded-full shadow-apple-sm">
                    ...
                    <span className="text-sm font-medium text-[#1d1d1f]">Análise de Desempenho</span>
                  </div>
                  <div className="h-px flex-1 bg-gradient-to-r from-transparent via-[#d1d1d6] to-transparent" />
                </div>
              </div>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-[#86868b]">
                          Visualize erros e notas TRI para criar revisões personalizadas.
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="flex items-center justify-between mb-6">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-[#86868b]">Clique em um horário para adicionar blocos de estudo</p>
                      </div>
                    </div>
                  </div>
        ...
        <div className="notion-page py-8">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <span className="text-sm font-medium text-[#1d1d1f]">XTRI Cronogramas</span>
                <span className="text-sm text-[#86868b] ml-2">Colégio Marista de Natal</span>
              </div>
            </div>
            <span className="text-xs text-[#a1a1a6] font-medium">Versão 2.0</span>
          </div>
        </div>
      </footer>
